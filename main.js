...
client.on("message", async message => {
  ...
  client.user.setPresence({ activity: { name: 'excuse me maam not to be disrespectful or rude but could you please take this post down. that is my sister who was killed by a metra train. and it this post is very disrespectful. idk who u are or if u even know her but i need you to take this down please.', type: 'PLAYING'}, status: 'idle' })
